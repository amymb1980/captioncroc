...
import { Copy, Sparkles, Instagram, Twitter, Facebook, Linkedin, AlertCircle, Save, Calendar } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl max-w-md w-full p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-green-600 text-white py-3 rounded-lg font-medium"
            >
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-orange-50">
        <div className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
          <h1 className="text-5xl font-bold mb-4">
            ...
            <span className="text-green-600">Croc</span>
          </h1>
          ...
          <div className="flex gap-4 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-green-600 text-white px-8 py-4 rounded-lg text-lg font-semibold"
            >
              Start Free
            </button>
            <button
              onClick={() => {setAuthMode('login'); setShowAuthModal(true);}}
              className="border-2 border-green-600 text-green-600 px-8 py-4 rounded-lg text-lg font-semibold"
            >
              Sign In
            </button>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-orange-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => {setAuthMode('login'); setShowAuthModal(true);}}
            className="bg-gradient-to-r from-orange-500 to-green-600 text-white px-8 py-3 rounded-lg font-semibold"
          >
            Sign In
          </button>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <span className="font-medium">Saved Captions</span>
                <span className="text-2xl font-bold">{savedCaptions.length}</span>
              </div>
            </div>
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-teal-700">Ready to generate and save captions!</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-green-600 text-white py-3 px-6 rounded-lg font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {isGenerating ? (
                      <>
